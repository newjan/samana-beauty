        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mb-4 text-sm sm:text-base text-gray-400">
              Your destination for beauty, wellness, and self-care. Experience luxury treatments in a serene environment.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/makeoverbysamana" className="text-gray-400 hover:text-pink-400 transition-colors active:scale-95" aria-label="Facebook">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/samanathebeautygallery" className="text-gray-400 hover:text-pink-400 transition-colors active:scale-95" aria-label="Instagram">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-400">
              <li className="flex items-start space-x-2 sm:space-x-3">
                ...
                <span className="min-w-0">Suryabinayak, Pandubazar<br />Bhaktapur, Nepal</span>
              </li>
              <li className="flex items-center space-x-2 sm:space-x-3">
                <span className="flex-shrink-0">📞</span>
                <a href="tel:+9779851277936" className="hover:text-pink-400 transition-colors break-all">
                  (977) 9851277936
                </a>
              </li>
              <li className="flex items-center space-x-2 sm:space-x-3">
                <span className="flex-shrink-0">✉️</span>
                <a href="mailto:samanabeautygallery@gmail.com" className="hover:text-pink-400 transition-colors break-all text-xs sm:text-sm">
                  samanabeautygallery@gmail.com
                </a>
              </li>
              <li className="flex items-start space-x-2 sm:space-x-3">
                <span className="flex-shrink-0">🕒</span>
                <span className="min-w-0">Mon-Sat: 9AM-7:30PM<br />Sun: 11AM-7:30PM</span>
              </li>
            </ul>
          </div>
        </div>
